...
public class EntityIMPrimedTNT extends Entity implements AdvancedSpawnData {
    ...
    public void setupTnt(LivingEntity shooter, float speed, float variance) {
    ...
    private void handleEntityHit(EntityHitResult entityHit) {
        int damage = (int) (Math.max(ticksInAir / 20.0F, 1.0F) * 7.0F);
        if (damage > 18) {
            damage = 18;
        }
